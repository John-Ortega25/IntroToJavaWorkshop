...
public class Code4Life {
	public static void main(String[] args) {
		...
		String question = JOptionPane.showInputDialog("How many hours have you been spent coding this week");
		int answerFromQuestion = Integer.parseInt(question);
		// * 1. If it's 3 or more, tell them they're a Code Ninja.
		if (answerFromQuestion==3||answerFromQuestion==4) {
